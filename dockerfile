...
RUN curl -sf -o freepbx-$FREEPBXVER.tgz -L http://mirror.freepbx.org/freepbx-$FREEPBXVER.tgz && \
    ...
    /usr/sbin/asterisk && \
    ./install_amp --installdb --username=$ASTERISKUSER --password=$ASTERISKDBPW && \
    amportal chown && \
...
mkdir /home/${USER}/asterix/backup && \
mkdir /home/${USER}/asterix/user && \
mkdir /home/${USER}/asterix/log && \
mkdir /home/${USER}/www/html && \

-v /etc/freepbxbackup:/home/${USER}/asterix/backup && \ 
-v /etc/asterisk:mkdir /home/${USER}/asterix/user && \
-v var/log/asterisk:/home/${USER}/asterix/log && \
-v /var/www:/home/${USER}/www/ && \
-v /var/www/html:/home/${USER}/www//html
